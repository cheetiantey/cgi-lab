...
# Referenced from: https://github.com/aianta/cgi-lab/blob/master/login.py
import cgi
import os
...
if (secret.username == username and secret.password == password) or ('logged' in cookies and cookies['logged'] == "true"):
